StackOverlow SAS: Two techniques to create formats from datasets
...
https://www.pharmasug.org/proceedings/2011/TT/PharmaSUG-2011-TT02.pdf
  ...
  3.  UTL_USRFMT Creates the following types of formats
       ...
       6.  Numeric   range to character
       7.  Character range to character
       8.  Character range to numeric
